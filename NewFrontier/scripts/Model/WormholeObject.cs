...
public class WormholeObject {
	...
	public byte GetNode1Sector => MapHelpers.GlobalGridToSectorIndex(_node1.Position);
	public byte GetNode2Sector => MapHelpers.GlobalGridToSectorIndex(_node2.Position);
